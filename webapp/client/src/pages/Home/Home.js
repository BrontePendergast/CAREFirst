    ...
    <Container className="mt-5 appcontainer">
      <Row>
        <Col md={3} className="topreasons">
          <TopReasons title="Top Reasons for Emergency Department Visits" reason={er_reasons} icon_class="fa-li fa-solid fa-truck-medical fa_icon_amb fa-lg" tooltip={er_tooltip} placement="right"/>
        </Col>
        ...
        <Col md={3} className="topreasons">
        <TopReasons title="Top Reasons for Urgent Care Visits" reason={uc_reasons} icon_class="fa-li fa-solid fa-user-doctor fa_icon_doc fa-lg" tooltip={uc_tooltip} placement="left"/>
        </Col>
      </Row>
    </Container>
  );
