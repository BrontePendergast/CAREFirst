...
# spam_repository.find_one_and_update(
# {'ObjectId': '611827f2878b88b49ebb69fc'},
# {'$set': {'foo.count': 500}}, upsert=True)

myquery = { "ObjectId": "611827f2878b88b49ebb69fc" }
newvalues = { "$set": { 'foo.count': 500 } }
spam_repository.update_one(myquery, newvalues)

database = client["example"]
spams = database["spams"]



for document in spams.find({}):
      print(document)