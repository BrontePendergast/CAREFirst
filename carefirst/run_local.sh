...
# # echo "Train the model with the training script we provide"
# # Ensure your API model is trained. Run the training script if needed
# FILE=trainer/model_pipeline.pkl
# if test -f "$FILE"; then
#     echo "$FILE exists."
# else 
#     echo "$FILE does not exist. Train model"
#     poetry run python trainer/train.py
#     echo "Move model artifact to api source directory"
#     cp trainer/model_pipeline.pkl src/model_pipeline.pkl
# fi
